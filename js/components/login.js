    ...
    <div class="container">
      <div style="max-width: 500px; margin: 4rem auto; text-align: center;">
        <div class="card" style="padding: 3rem;">
          <h1 style="color: var(--primary); margin-bottom: 1rem;">Bem-vindo!</h1>
          <p style="color: var(--dark-gray); margin-bottom: 2rem;">
            Faça login para publicar seus anúncios
          </p>
          
          <button class="btn btn-primary btn-block" id="btn-google-login" style="display: flex; align-items: center; justify-content: center; gap: 0.5rem;">
